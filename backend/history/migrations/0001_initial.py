    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex_count', models.JSONField(db_column='SEX_COUNT')),
                ('age_group_count', models.JSONField(db_column='AGE_GROUP_COUNT')),
                ('viewing_time_count', models.JSONField(db_column='TIME_COUNT')),
